  ...
  return (
    <div className="mb-8 flex justify-center overflow-x-auto px-4">
      <ul className="timeline timeline-vertical sm:timeline-horizontal">
        <li>
          <div className="timeline-start timeline-box">Entry</div>
        ...
        <li>
          ...
          <div className="timeline-end timeline-box">Pre-Storage</div>
          <hr className="bg-primary" />
        </li>
        <li>
          <hr className="bg-primary" />
          <div className="timeline-start timeline-box">Exit</div>
          <div className="timeline-middle">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
