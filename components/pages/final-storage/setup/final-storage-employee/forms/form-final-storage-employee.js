...
import useCreateFinalStorageEmployeeMutation from "./../../../../../../requests/request-final-storage/request-final-storage-employee/use-create-final-storage-employee-mutation";

export default function FormFinalStorageEmployee({ OnCancel }) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const createFinalStorageEmployeeMutation =
    useCreateFinalStorageEmployeeMutation();
  ...
  function isFormSubmit({
    ...
    createFinalStorageEmployeeMutation.mutateAsync({ formData });
  ...
  return (
    <>
      <div className="mt-10 flex flex-col items-center space-y-12 rounded-md border-2 border-red-500 bg-gray-900 p-4 sm:p-5 sm:px-12">
        <h1 className="text-xl font-bold">Add new "Final-Storage Employee"</h1>
